...
bool parseStatusMessage(u_int8_t *message, int length)
{
  if (spaStatusData.crc != message[message[1]])
  {
    ...
    spaStatusData.blower = bitRead(hexArray[13], 2);
    ...
    {
      spaControlParams.is_jet1_present = false;
      spaControlParams.jet1 = 0;
    ...
    {
      spaControlParams.is_jet2_present = false;
      spaControlParams.jet2 = 0;
      set_spaControlParams(spaControlParams);
    ...
    {
      spaControlParams.is_light1_present = false;
      spaControlParams.light1 = 0;
      set_spaControlParams(spaControlParams);
